...
// $Source: /usr/local/cvs/OpenSees/SRC/material/section/NLFiberSection2d.h,v $
                                                                        
// Written: fmk
// Created: 04/01
//
// Description: This file contains the class definition for 
// NLFiberSection2d.h. NLFiberSection2d provides the abstraction of a
// 2d beam section discretized by fibers. The section stiffness and
// stress resultants are obtained by summing fiber contributions.

#ifndef NLFiberSection2d_h
#define NLFiberSection2d_h
...
class NLFiberSection2d : public SectionForceDeformation
{
  public:
    NLFiberSection2d();
    NLFiberSection2d(int tag, int numFibers, Fiber **fibers);
    NLFiberSection2d(int tag, int numFibers);
    NLFiberSection2d(int tag, int numFibers, UniaxialMaterial **mats,
		   SectionIntegration &si);
    ~NLFiberSection2d();

    const char *getClassType(void) const {return "NLFiberSection2d";};
	...
	void setNLsectiondeformation(const Vector &nldef);
