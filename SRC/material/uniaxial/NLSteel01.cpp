...
OPS_NLSteel01()
{
  ...
  if (numData != 3 && numData != 5 && numData != 9) {
    opserr << "Invalid #args, want: uniaxialMaterial NLSteel01 " << iData[0] << " fy? E? b? <initStrain? maxStrain? a1? a2? a3? a4?>>" << endln;
    return 0;
  }
  ...
  if (numData == 3) {
	dData[3] = NLSTEEL_01_DEFAULT_INIT_STRAIN;
	dData[4] = NLSTEEL_01_DEFAULT_MAX_STRAIN;
    dData[5] = NLSTEEL_01_DEFAULT_A1;
    dData[6] = NLSTEEL_01_DEFAULT_A2;
    dData[7] = NLSTEEL_01_DEFAULT_A3;
    dData[8] = NLSTEEL_01_DEFAULT_A4;
  } else if (numData == 5) {
	dData[5] = NLSTEEL_01_DEFAULT_A1;
	dData[6] = NLSTEEL_01_DEFAULT_A2;
	dData[7] = NLSTEEL_01_DEFAULT_A3;
  ...
  theMaterial = new NLSteel01(iData[0], dData[0], dData[1], dData[2], dData[3], dData[4],
...
void NLSteel01::determineTrialState ()
{
...
{
   NLSteel01* theCopy = new NLSteel01(this->getTag(), fy, E0, b, initStrain, maxStrain,
				  a1, a2, a3, a4);
