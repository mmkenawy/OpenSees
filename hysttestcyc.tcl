...
set s3p [expr 0.2*$Fy];
set e3p [expr 1.4*$ets];

#set s2n [expr -1.01*$Fy];
set s2n [expr -$Fu];
set s3n -$s3p;
set e3n [expr 1.4*$ecs];
set pinchX 0.0;
set pinchY 0.8;
set damage1 0.0;
set damage2 0.0;
...
# RC section: 
   ...
   set nfCoreY 10;			# number of fibers for concrete in y-direction - core concrete
   set nfCoreZ 10;			# number of fibers for concrete in z-direction - 
...
set maxNumIter 1500;               		# Convergence Test: maximum number of iterations that will be performed before "failure to converge" is returned
